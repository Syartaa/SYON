let slide_data = [
    ...
    switch(i){
      ...
      default:
         ...
         if (container) {
            ...
            console.error("Container not found. Check if 'main-container' exists.");
          }
  ...
  function nextSlide(){
    ...
    if (slides.length >= 3 && captions.length >= 3) {
        ...
        console.error("Insufficient slides or captions for transition.");
      }
